...
with st.container(height=160, border=False):
    ...
    st.write("Y si no encuentras la respuesta que buscabas, puedo derivar tu consulta al administrador para que te brinde una respuesta por correo electrónico.")

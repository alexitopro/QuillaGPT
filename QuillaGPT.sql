...
- Si una de las fuentes proviene del Google Sites de la S. Académica de la FCI y el nombre del trámite tiene que ver con esa fuente, le mencionas que es importante mencionarle que FCI recomienda realizar el trámite por medio de los formularios a través de la plataforma Kissflow y le adjuntas el enlace.
2. Fuente:
